...
uint16_t WS2812FX::mode_chase_flash(void) {
  const static uint8_t flash_count = 3;
...
uint16_t WS2812FX::mode_custom_0() {
  setSegment(0, 0,   16, FX_MODE_BREATH,  PURPLE, 1000, false);      //front
  setSegment(1, 17, 30,   FX_MODE_TWINKLE_FADE, WHITE, 100, false);     //front wheel
  setSegment(2, 31,   104, FX_MODE_BREATH,  PURPLE, 1000, false);     //side
  setSegment(3, 105,   122, FX_MODE_TWINKLE_FADE,  WHITE, 100, true);   //rear wheel
  setSegment(4, 123,   150, FX_MODE_BREATH,  PURPLE, 1000, false);   //back
  setSegment(5, 151,   169, FX_MODE_DUAL_SCAN,  PURPLE, 1000, false);   //front nose
  setSegment(6, 170,   190, FX_MODE_MULTI_STROBE,  WHITE, 2000, false);   //fog light
  setSegment(7, 191,   200, FX_MODE_TWINKLE_FADE,  PURPLE, 100, false);   //front side vent
  
  return customModes[0]();
}
uint16_t WS2812FX::mode_custom_1() {
  setSegment(0, 0,   16, FX_MODE_SPARKLE,  PURPLE, 1000, false);      //front
  setSegment(1, 17, 30,   FX_MODE_TWINKLE_FADE, WHITE, 100, false);     //front wheel
  setSegment(2, 31,   104, FX_MODE_SPARKLE,  PURPLE, 1000, false);     //side
  setSegment(3, 105,   122, FX_MODE_TWINKLE_FADE,  WHITE, 100, true);   //rear wheel
  setSegment(4, 123,   150, FX_MODE_SPARKLE,  PURPLE, 1000, false);   //back
  setSegment(5, 151,   169, FX_MODE_HYPER_SPARKLE,  PURPLE, 1000, false);   //front nose
  setSegment(6, 170,   190, FX_MODE_SPARKLE,  WHITE, 2000, false);   //fog light
  setSegment(7, 191,   200, FX_MODE_HYPER_SPARKLE,  PURPLE, 100, false);   //front side vent
  
  return customModes[1]();
}
uint16_t WS2812FX::mode_custom_2() {
  setSegment(0, 0,   16, FX_MODE_STROBE_RAINBOW,  PURPLE, 100, false);      //front
  setSegment(1, 17, 30,   FX_MODE_TWINKLE_FADE, WHITE, 100, false);     //front wheel
  setSegment(2, 31,   104, FX_MODE_STROBE_RAINBOW,  PURPLE, 100, false);     //side
  setSegment(3, 105,   122, FX_MODE_TWINKLE_FADE,  WHITE, 100, true);   //rear wheel
  setSegment(4, 123,   150, FX_MODE_STROBE_RAINBOW,  PURPLE, 100, false);   //back
  setSegment(5, 151,   169, FX_MODE_COLOR_WIPE,  PURPLE, 1000, false);   //front nose
  setSegment(6, 170,   190, FX_MODE_SCAN,  WHITE, 2000, false);   //fog light
  setSegment(7, 191,   200, FX_MODE_HYPER_SPARKLE,  PURPLE, 100, false);   //front side vent
